...
public class AdaptateurDataRappel extends ArrayAdapter<Rappel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tv_data_rappel_prochain_rappel= (TextView) v.findViewById(R.id.data_tv_rappel_prochain_rappel);
        ...
        tv_data_rappel_prochain_rappel.setText(elt.getProchain_rappel());
